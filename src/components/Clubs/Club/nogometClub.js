...
class NogometClub extends Component {
    ...
    state={
       ...
       clubValue: 'nogomet',                                                        // prema tome se filtriraju
       subject: '',
       email: '',
       msg: '',
       eventDate: '',
    ...
    render() {
        ...
        let filteredMembers = this.state.members.filter(                                    // u toj varijabli se nalaze filtrirani clanovi 
                (member) => {
                    return  member.nogomet.toLowerCase().indexOf(this.state.clubValue.toLowerCase()) !== -1 
...
export default connect(mapStateToProps)(NogometClub);